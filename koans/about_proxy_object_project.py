...
class Proxy:
    ...
    def was_called(self, attribute_name):
        return attribute_name in self._messages

    def number_of_times_called(self, attribute_name):
        return len([m for m in self._messages if m == attribute_name])
